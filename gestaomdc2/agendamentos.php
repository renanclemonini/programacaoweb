            ...
            <p>
                ...
                ?>
                        <tr>
                            ...
                            <td>
                                <?php echo $objAgendamentos['idServico']; ?>
                    ...
                    <div class="modal-body">
                        <form action="./controle/ctr_agendamentos.php" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" placeholder="Digite seu nome" id="recipient-cliente" name="cliente">
                            </div>
                            <div class="form-group">
                                <label for="recipient-servico">Serviço:</label>
                                <input type="hidden" name="idServico" id="recipient-idServico">
                                <input type="text" class="form-control" placeholder="Digite serviço" id="recipient-servico" name="servico">
                            </div>
                            <div class="form-group">
                                <label for="recipient-dataAgendamento">Data:</label>
                                <input type="text" class="form-control" id="recipient-dataAgendamento" name="agendamento">
                            </div>
                            <div class="form-group">
                                <label for="recipient-horarioAgendamento">Horario:</label>
                                <input type="text" class="form-control" id="recipient-horarioAgendamento" name="horarioAgendamento">
                            </div>
